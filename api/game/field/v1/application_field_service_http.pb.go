...
const OperationFieldCreateField = "/game.api.game.field.v1.Field/CreateField"
const OperationFieldDeleteField = "/game.api.game.field.v1.Field/DeleteField"
const OperationFieldListField = "/game.api.game.field.v1.Field/ListField"
const OperationFieldListFieldType = "/game.api.game.field.v1.Field/ListFieldType"
const OperationFieldUpdateField = "/game.api.game.field.v1.Field/UpdateField"
...
func RegisterFieldHTTPServer(s *http.Server, srv FieldHTTPServer) {
	r := s.Route("/")
	r.GET("/game/api/v1/field/types", _Field_ListFieldType0_HTTP_Handler(srv))
	r.GET("/game/api/v1/fields", _Field_ListField0_HTTP_Handler(srv))
	r.POST("/game/api/v1/field", _Field_CreateField0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/field", _Field_UpdateField0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/field", _Field_DeleteField0_HTTP_Handler(srv))
}
...
func (c *FieldHTTPClientImpl) ListFieldType(ctx context.Context, in *ListFieldTypeRequest, opts ...http.CallOption) (*ListFieldTypeReply, error) {
	...
	pattern := "/game/api/v1/field/types"
	path := binding.EncodeURL(pattern, in, true)
