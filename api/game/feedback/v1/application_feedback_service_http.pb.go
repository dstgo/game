...
const OperationFeedbackCreateFeedback = "/game.api.game.feedback.v1.Feedback/CreateFeedback"
const OperationFeedbackCreateFeedbackCategory = "/game.api.game.feedback.v1.Feedback/CreateFeedbackCategory"
const OperationFeedbackDeleteFeedback = "/game.api.game.feedback.v1.Feedback/DeleteFeedback"
const OperationFeedbackDeleteFeedbackCategory = "/game.api.game.feedback.v1.Feedback/DeleteFeedbackCategory"
const OperationFeedbackListFeedback = "/game.api.game.feedback.v1.Feedback/ListFeedback"
const OperationFeedbackListFeedbackCategory = "/game.api.game.feedback.v1.Feedback/ListFeedbackCategory"
const OperationFeedbackUpdateFeedback = "/game.api.game.feedback.v1.Feedback/UpdateFeedback"
const OperationFeedbackUpdateFeedbackCategory = "/game.api.game.feedback.v1.Feedback/UpdateFeedbackCategory"
...
func RegisterFeedbackHTTPServer(s *http.Server, srv FeedbackHTTPServer) {
	r := s.Route("/")
	r.GET("/game/client/v1/feedback_categories", _Feedback_ListFeedbackCategory0_HTTP_Handler(srv))
	r.GET("/game/api/v1/feedback_categories", _Feedback_ListFeedbackCategory1_HTTP_Handler(srv))
	r.POST("/game/api/v1/feedback_category", _Feedback_CreateFeedbackCategory0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/feedback_category", _Feedback_UpdateFeedbackCategory0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/feedback_category", _Feedback_DeleteFeedbackCategory0_HTTP_Handler(srv))
	r.GET("/game/api/v1/feedbacks", _Feedback_ListFeedback0_HTTP_Handler(srv))
	r.POST("/game/client/v1/feedback", _Feedback_CreateFeedback0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/feedback", _Feedback_DeleteFeedback0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/feedback", _Feedback_UpdateFeedback0_HTTP_Handler(srv))
}
...
func (c *FeedbackHTTPClientImpl) CreateFeedback(ctx context.Context, in *CreateFeedbackRequest, opts ...http.CallOption) (*CreateFeedbackReply, error) {
	...
	pattern := "/game/client/v1/feedback"
...
func (c *FeedbackHTTPClientImpl) CreateFeedbackCategory(ctx context.Context, in *CreateFeedbackCategoryRequest, opts ...http.CallOption) (*CreateFeedbackCategoryReply, error) {
	...
	pattern := "/game/api/v1/feedback_category"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *FeedbackHTTPClientImpl) ListFeedbackCategory(ctx context.Context, in *ListFeedbackCategoryRequest, opts ...http.CallOption) (*ListFeedbackCategoryReply, error) {
	...
	pattern := "/game/api/v1/feedback_categories"
	path := binding.EncodeURL(pattern, in, true)
