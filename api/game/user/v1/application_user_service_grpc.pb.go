...
const (
	User_GetCurrentUser_FullMethodName    = "/game.api.game.user.v1.User/GetCurrentUser"
	User_UpdateCurrentUser_FullMethodName = "/game.api.game.user.v1.User/UpdateCurrentUser"
	User_GetUser_FullMethodName           = "/game.api.game.user.v1.User/GetUser"
	User_ListUser_FullMethodName          = "/game.api.game.user.v1.User/ListUser"
	User_CreateUser_FullMethodName        = "/game.api.game.user.v1.User/CreateUser"
	User_ImportUser_FullMethodName        = "/game.api.game.user.v1.User/ImportUser"
	User_ExportUser_FullMethodName        = "/game.api.game.user.v1.User/ExportUser"
	User_UpdateUser_FullMethodName        = "/game.api.game.user.v1.User/UpdateUser"
	User_UpdateUserStatus_FullMethodName  = "/game.api.game.user.v1.User/UpdateUserStatus"
	User_DeleteUser_FullMethodName        = "/game.api.game.user.v1.User/DeleteUser"
	User_GetTrashUser_FullMethodName      = "/game.api.game.user.v1.User/GetTrashUser"
	User_ListTrashUser_FullMethodName     = "/game.api.game.user.v1.User/ListTrashUser"
	User_DeleteTrashUser_FullMethodName   = "/game.api.game.user.v1.User/DeleteTrashUser"
	User_RevertTrashUser_FullMethodName   = "/game.api.game.user.v1.User/RevertTrashUser"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "game.api.game.user.v1.User",
	...
	Metadata: "api/game/user/application_user_service.proto",
}
