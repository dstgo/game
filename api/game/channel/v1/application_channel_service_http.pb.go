...
const OperationChannelCreateChannel = "/game.api.game.channel.v1.Channel/CreateChannel"
const OperationChannelDeleteChannel = "/game.api.game.channel.v1.Channel/DeleteChannel"
const OperationChannelListChannel = "/game.api.game.channel.v1.Channel/ListChannel"
const OperationChannelListChannelType = "/game.api.game.channel.v1.Channel/ListChannelType"
const OperationChannelUpdateChannel = "/game.api.game.channel.v1.Channel/UpdateChannel"
...
func RegisterChannelHTTPServer(s *http.Server, srv ChannelHTTPServer) {
	r := s.Route("/")
	r.GET("/game/api/v1/channel/types", _Channel_ListChannelType0_HTTP_Handler(srv))
	r.GET("/game/api/v1/channels", _Channel_ListChannel0_HTTP_Handler(srv))
	r.POST("/game/api/v1/channel", _Channel_CreateChannel0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/channel", _Channel_UpdateChannel0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/channel", _Channel_DeleteChannel0_HTTP_Handler(srv))
}
...
func (c *ChannelHTTPClientImpl) ListChannelType(ctx context.Context, in *ListChannelTypeRequest, opts ...http.CallOption) (*ListChannelTypeReply, error) {
	...
	pattern := "/game/api/v1/channel/types"
	path := binding.EncodeURL(pattern, in, true)
