...
const OperationUserinfoCreateUserinfo = "/game.api.game.userinfo.v1.Userinfo/CreateUserinfo"
const OperationUserinfoDeleteUserinfo = "/game.api.game.userinfo.v1.Userinfo/DeleteUserinfo"
const OperationUserinfoListUserinfo = "/game.api.game.userinfo.v1.Userinfo/ListUserinfo"
const OperationUserinfoUpdateUserinfo = "/game.api.game.userinfo.v1.Userinfo/UpdateUserinfo"
...
func RegisterUserinfoHTTPServer(s *http.Server, srv UserinfoHTTPServer) {
	r := s.Route("/")
	r.GET("/game/api/v1/userinfoes", _Userinfo_ListUserinfo0_HTTP_Handler(srv))
	r.POST("/game/api/v1/userinfo", _Userinfo_CreateUserinfo0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/userinfo", _Userinfo_UpdateUserinfo0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/userinfo", _Userinfo_DeleteUserinfo0_HTTP_Handler(srv))
}
...
func (c *UserinfoHTTPClientImpl) ListUserinfo(ctx context.Context, in *ListUserinfoRequest, opts ...http.CallOption) (*ListUserinfoReply, error) {
	...
	pattern := "/game/api/v1/userinfoes"
	path := binding.EncodeURL(pattern, in, true)
