...
const OperationAppCreateApp = "/game.api.game.app.v1.App/CreateApp"
const OperationAppDeleteApp = "/game.api.game.app.v1.App/DeleteApp"
const OperationAppGetApp = "/game.api.game.app.v1.App/GetApp"
const OperationAppListApp = "/game.api.game.app.v1.App/ListApp"
const OperationAppUpdateApp = "/game.api.game.app.v1.App/UpdateApp"
const OperationAppUpdateAppStatus = "/game.api.game.app.v1.App/UpdateAppStatus"
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	r := s.Route("/")
	r.GET("/game/client/v1/app", _App_GetApp0_HTTP_Handler(srv))
	r.GET("/game/api/v1/app", _App_GetApp1_HTTP_Handler(srv))
	r.GET("/game/api/v1/apps", _App_ListApp0_HTTP_Handler(srv))
	r.POST("/game/api/v1/app", _App_CreateApp0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/app", _App_UpdateApp0_HTTP_Handler(srv))
	r.PUT("/game/api/v1/app/status", _App_UpdateAppStatus0_HTTP_Handler(srv))
	r.DELETE("/game/api/v1/app", _App_DeleteApp0_HTTP_Handler(srv))
}
...
func (c *AppHTTPClientImpl) UpdateAppStatus(ctx context.Context, in *UpdateAppStatusRequest, opts ...http.CallOption) (*UpdateAppStatusReply, error) {
	...
	pattern := "/game/api/v1/app/status"
	path := binding.EncodeURL(pattern, in, false)
