...
func (c *serverClient) Hello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Server_Hello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServerServer) Hello(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
var Server_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v1/server/game_server_service.proto",
}
